...
const ChatListModal = ({ open, onClose }) => {
  ...
  return (
    <Modal
      isOpen={true}
      className="ChatList animate__animated animate__fadeIn animate__slow"
    >
      ...
      <ScrollToBottom className="message-container" mode="top">
        {data.data.lastChats &&
          data.data.lastChats.map((data, idx) => {
            return (
              data != null && (
                <div
                  className="listC animate__animated animate__fadeInDown animate__fast"
                  key={idx}
                >
                  <div className="ChatListContainer">
                    <div
                      ...
                      onClick={() => {
                        ...
                        axios
                          .get(`${url}/api/chats/messages/` + data.roomId, {
                            headers: {
                    ...
                    >
                      ...
                      <div className="ChatContent">
                        {data.message.length > 27
                          ? data.message.slice(0, 27) + "..."
                          : data.message}
                      </div>
                    </div>
                      ...
                      <div className="ChatDel">
                        <BsTrashFill
                          onClick={() => {
                            axios
                              .put(
                                `${url}/api/chats/rooms/` + data.roomId,
                                null,
                                {
