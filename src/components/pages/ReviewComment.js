...
const ReviewComment = () => {
  ...
  const addComment = () => {
    ...
    axios
      .post(`${url}/api/reviews/` + reviewPostId + "/comments", comment_data, {
        headers: {
  ...
  const deleteComment = (e) => {
    ...
    axios
      .delete(
        `${url}/api/reviews/` + reviewPostId + "/comments/" + e.target.id,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
          },
            ...
            return (
              <div className="box" key={index}>
                ...
                {nickname === data.nickname ? (
                  ...
                  >
                    <img id={data.reviewCommentId} src={img_delete} />
                  </button>
                ) : (
                  <></>
                )}
